abbstrmap={
	...
	#################################################################
	'jsname1':		'阿本長大義福谷黑伊吉空柳名泥欧佩前柔三藤雾武万小羽中',
	'jsname2':		'岸部川岛刈方冈河乙江口里木南林浦旗蕊山田屋尾窝溪野泽',
	'jgname1':		'奥柏池德恩枫高惠爱久康隆麻那泉盘曲仁尚太有五吻信英正',
	'jgname2':		'安阪成東儿夫光弘怡家堀郎美宁源平桥榕松韬柚尉丸香洋子',
	#################################################################
	'csname':		'安白陈丁尔冯郭黄艾蒋孔雷毛倪袁潘钱阮孙唐吴韦王徐杨张',
	'cgname1':		'阿博春道易飞桂海依家克乐明宁凌培启睿世铁友维文晓雨志',
	'cgname2':		'昂彬才丹娥凤刚华一军坤亮美楠权朋强荣生涛悠伟望新越忠',
}
occupation_dct={
	'辅助':'有爱',
	'法师':'沉稳',
